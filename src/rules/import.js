...
export default {
  ...
  "import/no-unresolved": ["error", { 
    ...
    ignore: ["eslint", "eslint-config-amex", "@americanexpress"]
  }],
  ...
  // https://github.com/import-js/eslint-plugin-import/blob/v2.32.0/docs/rules/default.md
  "import/default": "off",

  // https://github.com/import-js/eslint-plugin-import/blob/v2.32.0/docs/rules/namespace.md
  ...
  // https://github.com/import-js/eslint-plugin-import/blob/v2.32.0/docs/rules/no-named-as-default.md
  ...
  // https://github.com/import-js/eslint-plugin-import/blob/v2.32.0/docs/rules/no-duplicates.md
