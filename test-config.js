...
export default defineConfig([
  ...
  {
    // https://github.aexp.com/amex-eng/one-app-dependencies/blob/main/packages/cli/amex-one-app-module-template/js-template/__tests__/.eslintrc.json.ejs
    // https://github.aexp.com/amex-eng/one-app-dependencies/blob/main/packages/cli/amex-one-app-module-template/js-template/__mocks__/.eslintrc.json.ejs
    name: "test files",
    // files: ["**/__tests__/**", "**/__mocks__/**"], // this should be defined in module eslint.config.js
    plugins: {
